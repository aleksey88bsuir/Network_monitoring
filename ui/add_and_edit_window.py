...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(455, 440)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Dialog.sizePolicy().hasHeightForWidth())
        Dialog.setSizePolicy(sizePolicy)
        Dialog.setMinimumSize(QtCore.QSize(455, 440))
        Dialog.setMaximumSize(QtCore.QSize(455, 440))
        self.label_8 = QtWidgets.QLabel(Dialog)
        self.label_8.setGeometry(QtCore.QRect(10, 170, 141, 17))
        self.label_8.setObjectName("label_8")
        self.name_edit = QtWidgets.QLineEdit(Dialog)
        self.name_edit.setGeometry(QtCore.QRect(160, 100, 291, 31))
        self.name_edit.setObjectName("name_edit")
        self.l_warning_ip_add = QtWidgets.QLabel(Dialog)
        self.l_warning_ip_add.setGeometry(QtCore.QRect(160, 80, 291, 17))
        ...
        self.l_warning_name.setGeometry(QtCore.QRect(160, 140, 291, 17))
        self.l_warning_name.setObjectName("l_warning_name")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(10, 100, 72, 17))
        ...
        self.checkBox.setGeometry(QtCore.QRect(160, 50, 141, 23))
        self.checkBox.setObjectName("checkBox")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(10, 20, 101, 17))
        self.label.setObjectName("label")
        self.label_9 = QtWidgets.QLabel(Dialog)
        self.label_9.setGeometry(QtCore.QRect(10, 210, 101, 17))
        self.label_9.setObjectName("label_9")
        self.descr_edit = QtWidgets.QTextEdit(Dialog)
        self.descr_edit.setGeometry(QtCore.QRect(160, 210, 291, 192))
        self.descr_edit.setObjectName("descr_edit")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(10, 410, 251, 17))
        self.label_2.setObjectName("label_2")
        self.b_cancel = QtWidgets.QPushButton(Dialog)
        self.b_cancel.setGeometry(QtCore.QRect(270, 410, 89, 25))
        self.b_cancel.setObjectName("b_cancel")
        self.b_ok = QtWidgets.QPushButton(Dialog)
        self.b_ok.setGeometry(QtCore.QRect(362, 410, 89, 25))
        self.b_ok.setObjectName("b_ok")
        self.b_play_sound = QtWidgets.QPushButton(Dialog)
        self.b_play_sound.setGeometry(QtCore.QRect(420, 170, 31, 31))
        self.b_play_sound.setObjectName("b_play_sound")
        self.alarm_edit = QtWidgets.QComboBox(Dialog)
        self.alarm_edit.setGeometry(QtCore.QRect(160, 170, 251, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.b_play_sound.setText(_translate("Dialog", ">"))
